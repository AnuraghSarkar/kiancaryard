      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          {carImages.length > 0 ? (
            ...
            <div className="card p-6 mb-6 text-center bg-gray-100">
              <div className="py-12">
          ...
          <div className="card p-6 sticky top-20">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a 
                  href={`https://wa.me/${formatPhoneForWhatsApp(car.phone)}?text=Hi, I'm interested in the ${car.year} ${car.make} ${car.model} listed for $${car.price.toLocaleString()}. Can you provide more details?`}
                  target="_blank"
